...
import com.teammeditalk.medicalconnect.databinding.FragmentOnboadring3Binding
...
@AndroidEntryPoint
class ThirdOnBoardingFragment :
    BaseFragment<FragmentOnboadring3Binding>(
        FragmentOnboadring3Binding::inflate,
    ) {
